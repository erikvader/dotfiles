...
local opts = {
    ...
    {"240p"  : "bestvideo[height<=240]+bestaudio/best[height<=240]/bestvideo+bestaudio/best"},
    {"144p"  : "bestvideo[height<=144]+bestaudio/best[height<=144]/bestvideo+bestaudio/best"}
    ]
    ]],
}
